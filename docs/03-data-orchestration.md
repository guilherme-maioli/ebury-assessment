...
**Purpose**: Data cleaning and validation <br>
**Module**: `clean_transactions_pipeline.py` <br>
**Tasks**: 1 task <br>
...
**Purpose**: Database loading and validation <br>
**Module**: `load_to_postgres_pipeline.py` <br>
**Tasks**: 4 tasks <br>
...
**Purpose**: Dimensional modeling <br>
**Module**: `dbt_transformations_pipeline.py` <br>
**Tasks**: Auto-generated by Cosmos <br>
...
**Access**: http://localhost:8081 <br>
**Credentials**: airflow / airflow <br>
